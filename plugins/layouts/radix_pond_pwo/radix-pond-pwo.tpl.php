...
<div class="panelpane-width-options-layout panel-display pond clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
    ...
    <div class="radix-layouts-footer panel-panel">
      <div class="panel-panel-inner">
